...
ENUMERATIONS['transport_schemes'] = {
    ...
    'members': [
        ...
        ('Uses atmospheric dynamics transport scheme', None),
...
ENUMERATIONS['turbulence_methods'] = {
    'description':'Methods used for turbulence parameterization',
    'is_open': True,
    'members':[
        ('Uses atmospheric chemistry turbulence scheme', None),
        ('Uses atmospheric physics turbulence scheme', None),
